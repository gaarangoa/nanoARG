...
def color_map():
    ...
    # 
    _args_color_list = list(_cargs.range_to(Color("#a31017"), len(args_data))) + list(Color('#28ba45').range_to(Color("#767f13"), len(args_data))) + list(Color('#91d8b4').range_to(Color("#d3d891"), len(args_data)))
    random.seed(0)
