...
cmd = "\n".join([
    ...
    'module load jdk/1.8.0 cuda/7.0.28 python/2.7.10 gcc/5.2.0 openmpi/1.8.5 hmmer atlas bowtie2 samtools bedtools\n',
    ...
    '/groups/metastorm_cscee/nanoARG/backend/scheduler/remote/environment/bin/luigi --module ' + \
