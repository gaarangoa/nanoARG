...
var PfamGraphic = Class.create({
    ...
    setSequence: function(sequence) {
        ...
        ].max() + [this._heights.lollipops.downMax,
        ...
        this._baseline = [this._heights.lollipops.upMax,
            this._heights.bridges.upMax,
            this._imageParams.regionHeight / 2
        ].max() + 1;
        // that single pixel is just a fudge factor...
    ...
    _drawSequence: function() {
        ...
        // add an area
        return {
            label: "sequence", // TODO make this more informative...
            text: "sequence",
    ...
    */
    ...
    _drawHighlight: function() {
        ...
        var area = {
            start: this._sequence.highlight.start,
            end: this._sequence.highlight.end,
            coords: [left, top,
                right, bottom
            ],
            tip: {
                title: this._sequence.highlight.text || "Highlighted region",
