...
var MetadataComponent = (function () {
    function MetadataComponent(router, sampleService, route, session, fb, sampleComponent, projectComponent) {
        ...
        this.newSampleForm = this.fb.group({
            ...
            'secondary-group': [undefined, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__classes_abundance_class__ = __webpack_require__("../../../../../src/classes/abundance.class.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Gmap__ = __webpack_require__("../../../../../src/app/project/view-samples/Gmap.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__network__ = __webpack_require__("../../../../../src/app/project/view-samples/network.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__taxonomy__ = __webpack_require__("../../../../../src/app/project/view-samples/taxonomy.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ViewSamplesComponent = (function () {
    ...
    ViewSamplesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.read_chart = new __WEBPACK_IMPORTED_MODULE_8__Gmap__["a" /* Genome */]();
        this.network = new __WEBPACK_IMPORTED_MODULE_9__network__["a" /* Network */]();
        this.taxonomy_visualization = new __WEBPACK_IMPORTED_MODULE_10__taxonomy__["a" /* TaxonomyVisualization */]();
        this.selected_read = {
            id: 0,
            taxa: 0
        };
        this.sub = this.route.params.subscribe(function (params) {
            ...
            _this.sampleService.getSamplesByProject(_this.projectComponent.projectID)
                ...
                _this.absoluteAbundance = new __WEBPACK_IMPORTED_MODULE_6__classes_abundance_class__["a" /* AbsoluteAbundance */]();
                _this.absoluteAbundance.getTypeAbsoluteAbundance(samples);
                _this.compare_samles_stacked_bar = {
                    chart: {
                        type: 'bar'
                    },
                    credits: {
                    ...
                    title: { text: null },
                    xAxis: {
                        categories: _this.absoluteAbundance.categories
                    },
                    series: _this.absoluteAbundance.type_series,
                    legend: {},
                    plotOptions: {
                        series: {
                            stacking: 'percent',
    ...
    ViewSamplesComponent.prototype.download_type = function (kind) {
        var blob = new Blob([this.absoluteAbundance[kind]], { type: 'text/plain;charset=utf-8' });
        var url = URL.createObjectURL(blob);
        // window.open(url, '_blank', "");
        __WEBPACK_IMPORTED_MODULE_7_file_saver__["saveAs"](blob, kind + '_distribution.csv');
    };
    ...
    ViewSamplesComponent.prototype.reRun = function () {
    };
...
/***/ "../../../../../src/classes/abundance.class.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AbsoluteAbundance; });
var AbsoluteAbundance = (function () {
    function AbsoluteAbundance() {
        this.type_series = [];
        this.subtype_series = [];
        this.type_names = [];
        this.subtype_names = [];
    ...
    AbsoluteAbundance.prototype.getTypeAbsoluteAbundance = function (samples) {
        for (var sample in samples) {
            if (!samples[sample].ARG) {
                continue;
            }
            var aux = Object.keys(samples[sample].ARG.type);
        ...
        var setT = new Set(this.type_names);
        var setSt = new Set(this.subtype_names);
        ...
        for (var set = 0; set < this.subtype_names.length + this.type_names.length; set++) {
            ...
            for (var sample in samples) {
                if (!samples[sample].ARG) {
                    continue;
                } // check if the sample has been already analyzed
                var S = samples[sample];
                var value = S.ARG.type[this.type_names[set]];
                if (value) {
                    type.push(value);
                }
                else {
            ...
            for (var sample in samples) {
                ...
                var S = samples[sample];
                var value = S.ARG.subtype[this.subtype_names[set]];
                if (value) {
                    subtype.push(value);
                }
                else {
    ...
    return AbsoluteAbundance;
}());
//# sourceMappingURL=/Volumes/drive/projects/ARG/nanopore/frontend/src/abundance.class.js.map
